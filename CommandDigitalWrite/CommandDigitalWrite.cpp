...
void* globalCommandDigitalWritePt2Object;

CommandDigitalWrite::CommandDigitalWrite(int mypin, int myInitLevel) {
  pin = mypin;
  initLevel = myInitLevel;
}

/**
* register to a CommandManager
*/
void CommandDigitalWrite::registerToCommandManager(CommandManager &cmdMng, const char *command) {
...
*/
void CommandDigitalWrite::wrapper_init(void* pt2Object) {
  // explicitly cast to a pointer to Classname
  CommandDigitalWrite* self = (CommandDigitalWrite*) pt2Object;
  self->init();
}

void CommandDigitalWrite::init() {
  #ifdef COMMANDDIGITALWRITE_DEBUG
    Serial.println("Init CommandDigitalWrite");
  #endif
  ...
  cmdHdl.addCommand(COMMANDDIGITALWRITE_WRITE, wrapper_write);
...
* the wrapper is used by CommandManager
*/
void CommandDigitalWrite::wrapper_handleCommand(const char *command, void* pt2Object) {
  // each time the handleCommand is called, it is given the command and the pointer to the instance that should handle it
  globalCommandDigitalWritePt2Object = pt2Object;
  // explicitly cast to a pointer to Classname
  CommandDigitalWrite* self = (CommandDigitalWrite*) globalCommandDigitalWritePt2Object;

  self->handleCommand(command);
}

void CommandDigitalWrite::handleCommand(const char *command) {
  #ifdef COMMANDDIGITALWRITE_DEBUG
...
* the wrapper is used by CommandManager
*/
void CommandDigitalWrite::wrapper_setHeader(const char *cmdHeader, void* pt2Object) {
  // explicitly cast to a pointer to Classname
  CommandDigitalWrite* self = (CommandDigitalWrite*) pt2Object;
  self->setHeader(cmdHeader);
}

void CommandDigitalWrite::setHeader(const char *cmdHeader) {
  #ifdef COMMANDDIGITALWRITE_DEBUG
    Serial.print("Set Header CommandDigitalWrite to ");
...
* the wrapper is used by CommandManager
*/
void CommandDigitalWrite::wrapper_update(void* pt2Object) {
  // explicitly cast to a pointer to Classname
  CommandDigitalWrite* self = (CommandDigitalWrite*) pt2Object;
  self->update();
}

void CommandDigitalWrite::update() {
...
* change the COMMANDDIGITALWRITE_BONJOUR_ID and ensure it is unique to your new device
* keep COMMANDDIGITALWRITE_BONJOUR_ID short
* do not forget to change the name ofthis variable apropriately
*/
void CommandDigitalWrite::wrapper_bonjour()
{
  // explicitly cast to a pointer to Classname
  CommandDigitalWrite* self = (CommandDigitalWrite*) globalCommandDigitalWritePt2Object;
  self->bonjour();
...
void CommandDigitalWrite::bonjour() {
  #ifdef COMMANDDIGITALWRITE_DEBUG
  ...
  cmdHdl.addCmdDelim();
  cmdHdl.addCmdString(COMMANDDIGITALWRITE_BONJOUR_ID);
  cmdHdl.addCmdTerm();
...
*/
void CommandDigitalWrite::wrapper_unrecognized(const char *command) {
  // explicitly cast to a pointer to Classname
  CommandDigitalWrite* self = (CommandDigitalWrite*) globalCommandDigitalWritePt2Object;
  self->unrecognized(command);
}

void CommandDigitalWrite::unrecognized(const char *command) {
  cmdHdl.initCmd();
...
*/
void CommandDigitalWrite::wrapper_write()
{
  // explicitly cast to a pointer to Classname
  CommandDigitalWrite* self = (CommandDigitalWrite*) globalCommandDigitalWritePt2Object;
  self->write();
